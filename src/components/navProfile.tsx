    ...
    <div className={'flex flex-col items-center'}>
      ...
      {showMenu ? (
        <div className={'relative'}>
          <div
            className={`fixed inset-y-0 top-14 right-6 ${profileHeight} w-60 rounded-sm bg-white shadow-md`}
          >
            <div className={'flex h-full flex-col justify-center p-2'}>
              ...
              >
                {user.avatar ? (
                  <Image
                    ...
                    priority={true}
                    className={
                      'h-10 w-10 mr-1 rounded-full border border-gray-300'
                    }
                  />
                ) : (
                  false
              ...
              <div className={` mt-1 py-1 px-1 hover:bg-gray-100`}>
